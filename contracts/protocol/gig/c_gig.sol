...
import {c_gig_storage} from './c_gig_storage.sol';
import {i_gig} from "../../interfaces/i_gig.sol";
...
contract	c_gig	is VersionedInitializable, c_gig_storage, i_gig
{
	...
	**/
	...
	/// @inheritdoc i_gig
	function	create_gig(l_data_types.s_package[] memory packages)
		external  
	{
		...
		Counters.increment(_total_gigs);
		...
		require(is_created && new_id == _total_gigs._value, l_errors.INVALID_GIG_ID);
	}
