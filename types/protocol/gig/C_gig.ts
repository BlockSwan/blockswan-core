...
export interface C_gigInterface extends utils.Interface {
  functions: {
    "ADDRESSES_PROVIDER()": FunctionFragment;
    "GIG_REVISION()": FunctionFragment;
...
export interface C_gig extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: C_gigInterface;
  ...
  functions: {
    ...
    GIG_REVISION(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    GIG_REVISION(overrides?: CallOverrides): Promise<PopulatedTransaction>;
