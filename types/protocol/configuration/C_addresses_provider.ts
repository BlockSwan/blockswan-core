...
export interface C_addresses_providerInterface extends utils.Interface {
  functions: {
...
export interface C_addresses_provider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: C_addresses_providerInterface;
  ...
  functions: {
    ...
    set_protocol_configurator_impl(
      new_protocol_configurator_impl: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
